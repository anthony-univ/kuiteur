...
function em_html_a(string $url, string $support_lien, ?string $query_string_nom = null, ?string $query_string_val = null, ?string $title = null):string{
    ...
    //echo "passer<br>";
    $query_string_val = crypteSigneURL($query_string_val);
    $query_string = $query_string_nom ? "?{$query_string_nom}=".$query_string_val : '';
...
* Renvoie le code HTML d'un élément a
*
* supporte plusieurs  couple 'nom=valeur' dans la queryString
*
*
* @param  string    $url                url du lien
* @param  string    $support_lien       support du lien
* @param  ?array    $argumentsUrl       nom des couple 'nom=valeur'
* @param  ?string   $title              info bulle
* @return string                        Le code HTML du lien
*/
function em_html_a_array(string $url, string $support_lien, ?array $argumentsUrl = null, ?string $title = null):string{
    $title = $title ? " title='$title'" : '';
    $query_string = $argumentsUrl ? '?' : '';
    
    foreach ($argumentsUrl as $key => $value) {
        $value = crypteSigneURL($value);
